...
<div id="wrapper">
	...
	<div id="main">
		...
		<div id="content">
			<noscript>
				<div class="noscriptalert">現在お使いのブラウザのJavaScriptの設定が無効になっています。<br/>投稿の日時指定機能を利用するためには、JavaScriptの設定を有効にしてください。</div>
			</noscript>
			...
			<form action="entry" method="POST" name="form"
				...
				<table class="entryform_table">
					<tr>
						...
						<td>
							<span class="explain">投稿の件名を50文字以下で入力してください</span>
						</td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						...
						<td>
							<span class="explain">投稿の本文を1000文字以下で入力してください</span>
						</td>
					</tr>
					<tr>
						<td></td>
						<td>
							<textarea name="text" rows="9" cols="46" maxlength="1000"></textarea>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<span class="explain">投稿の日時を指定する場合、チェックし投稿日時をお選び下さい。そのままの場合、投稿した時間が投稿日時となります</span>
						</td>
					</tr>
					<tr>
						<td></td>
						<td>
							<label><input type="checkbox" name="conReleasedAppoint" value="1" onclick="process()"/> 投稿日時を指定する</label>
						</td>
					</tr>
					<tr>
						<td></td>
						<td class="input_timefield">
							...
							<select name="minute" id="minute" disabled>
								<option value=""></option>
							</select>分　
					</tr>
					<tr>
