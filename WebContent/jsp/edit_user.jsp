...
<div id="wrapper">
	...
	<div id="main">
		...
		<div id="content">
			<noscript>
				<div class="noscriptalert">現在お使いのブラウザのJavaScriptの設定が無効になっています。<br/>パスワードの変更機能を利用するためには、JavaScriptの設定を有効にしてください。</div>
			</noscript>
			...
			<form action="/bbs/ManageUsers" name="form" method="POST" onSubmit="return check()">
				<table class="user_form">
					<tr>
						...
						<td>
							<input type="text" name="name" maxlength="10" value="<%= information.get("userName")%>"/>
						</td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						...
						<td>
							<input type="text" name="account_id" maxlength="20" value="<%= information.get("userAccountId")%>"/>
						</td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						...
						<td>
							<label><input type="checkbox" name="chengePass" value="1" onclick="processPass()"/> パスワードを変更する</label>
						</td>
					</tr>
					<tr>
						<td></td>
						<td>
							<input class="inputPass" type="password" name="account_pass" maxlength="255" disabled/>
						</td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						...
						<td>
							<input class="inputPass" type="password" name="pass_com" maxlength="255" disabled/>
						</td>
					</tr>
					<tr>
						<td></td>
					...
					<tr>
						...
						<% if (authUserId == userId) {%>
							<span class="explain">自身の管理者権限を変えることは出来ません。</span>
						<% } else { %>
							<% if (information.get("userAuth").equals("0")) { %>
								<label><input type="radio" name="auth" value="0" checked="checked">権限なし</label>　　　　　
								<label><input type="radio" name="auth" value="1">権限あり</label>
							<% } else { %>
								<label><input type="radio" name="auth" value="0" >権限なし</label>　　　　　
								<label><input type="radio" name="auth" value="1" checked="checked">権限あり</label>
							<% } %>
						<% } %>
						</td>
					</tr>
