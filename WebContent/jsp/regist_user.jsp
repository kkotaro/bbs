				...
				<form action="/bbs/RegistUser" method="POST" name="form"
					...
					<table class="user_form">
						...
						<tr>
							...
							<td><input type="text" name="account_id" maxlength="20" /></td>
						</tr>
						<tr>
							<td></td>
						...
						<tr>
							...
							<td><input type="password" name="pass_com" maxlength="255" />
							</td>
						</tr>
						<tr>
							<td></td>
						...
						<tr>
							...
							<td><label><input type="radio" name="auth" value="0"
									checked="checked">権限なし</label> <label><input
									type="radio" name="auth" value="1">権限あり</label></td>
						</tr>
						<tr>
						...
						<tr>
							<td></td>
							<td><input type="hidden" name="mode" value="adduser" /> <input
