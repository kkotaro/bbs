...
<div id="wrapper">
	...
	<div id="main">
		...
		<div id="content">
			...
			<p class="sub_topic">ログインユーザー管理</p>
				<table class="login_user_table">
					...
					<tr>
						...
						<td>
							<a href="/bbs/ControlUserServlet?mode=edit&user_id=<% out.println(account.getUserId()); %>">
							<span class="stop_button">
								<img align="top" alt="編集" src="resorce/edit.png" width="20px">
								編集する
							</span>
						</a>
						</td>
			...
			<a href="/bbs/RegistUser">
				<span class="entry_button"><img align="top" alt="新規登録" src="resorce/adduser.png" width="20px">ユーザを新規登録</span>
			</a>
			</div>
				...
				<table class="user_list_table">
					...
					<tr>
						...
						<td rowspan="2" align="center">
							<% if (accounts.getAuth() == 1) {%>
								<img align="top" alt="停止" src="resorce/circle.png" width="20px">
							<% } else { %>
								-
							<% } %>
						</td>
						<td align="center" class="user_con">
							<%if (accounts.getCondition() == 0) { %>
								現在稼働中
							<%} else { %>
								<font color="#EE6557">現在停止中</font>
							<% } %>
						</td>
						<td rowspan="2" align="center" >
							<a href="/bbs/ControlUserServlet?mode=edit&user_id=<%= accounts.getUserId() %>">
								<span class="stop_button">
									<img align="top" alt="編集" src="resorce/edit.png" width="20px">
									編集する
								</span>
						...
						<% if (accounts.getCondition() == 0) { %>
						<form action="/bbs/ControlUserServlet" method="POST" onSubmit="return stopCom()">
							<button type="submit" class="form_button" >
								<img align="top" alt="停止" src="resorce/minus.png" width="20px">
								停止させる
							</button>
							<input type="hidden" name="user_id" value="<%= accounts.getUserId()%>"/>
							<input type="hidden" name="mode" value="stop"/>
						<% } else { %>
						<form action="/bbs/ControlUserServlet" method="POST" onSubmit="return runCom()">
							<button type="submit" class="form_button" >
