...
<div id="wrapper">
	...
	<div id="main">
		<div class="login">
			...
			<% } %>
			<form action="/bbs/Login" method="POST" name="form" onSubmit="return check()">
				<table>
					<tr>
						<td>
							<input type="text" name="id" placeholder="ログインID" maxlength="20"/>
						</td>
					</tr>
					<tr>
						<td>
							<input type="password" name="pass" placeholder="パスワード" maxlength="255"/>
						</td>
					</tr>
					<tr>
						<td align="right">
